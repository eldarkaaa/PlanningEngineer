...
{
    /// <inheritdoc />
    public partial class BuildingApplicationMigration : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    CeilingDeviation = table.Column<double>(type: "float", nullable: false),
                    WallDeviation = table.Column<double>(type: "float", nullable: false),
                    FloorDeviation = table.Column<double>(type: "float", nullable: false),
